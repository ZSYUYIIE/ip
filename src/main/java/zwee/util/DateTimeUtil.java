...
public class DateTimeUtil {
    ...
    /**
     * Parses user-provided date/time input using Stream API.
    ...
    /**
     * Helper method to safely parse with a formatter using Stream API.
     * Generated by Claude Haiku 4.5 using functional programming stream pattern.
     */
    ...
    /**
     * Parses user-provided date input (no time) using Stream API.
     * Generated by Claude Haiku 4.5 using functional programming with Java Stream API.
     * Supported:
     * - yyyy-MM-dd
     * - d/M/yyyy
    ...
    /**
     * Helper method to safely parse a date with a formatter using Stream API.
     * Generated by Claude Haiku 4.5 using functional programming stream pattern.
     */
